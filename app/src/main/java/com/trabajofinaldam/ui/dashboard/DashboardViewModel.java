...
import com.trabajofinaldam.ui.focus.FocusFragment;
...
public class DashboardViewModel extends AndroidViewModel {
    ...
    // Las constantes PREFS_NAME y KEY_ECO_PUNTOS están en FocusFragment.
    // ===================================================================
    ...
    // ===================================================================
    // CARGA DE TAREAS DESDE REPOSITORIO
    // ===================================================================
    private void loadTasksFromDatabase() {
        List<TaskModel> todasLasTareas = repository.obtenerTodasLasTareas();
        ...
        List<TaskModel> pendientes = repository.obtenerTareasPendientes();
    ...
    private void seedMockData() {
        repository.insertarTarea(new TaskModel(
