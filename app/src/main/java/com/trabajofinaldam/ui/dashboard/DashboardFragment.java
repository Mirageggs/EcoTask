...
public class DashboardFragment extends Fragment {
    ...
    private void setupRecyclerView() {
        ...
        taskAdapter = new TaskAdapter(new ArrayList<>(), this::abrirEnfoque);
        recyclerTasks.setAdapter(taskAdapter);
    }

    private void abrirEnfoque(TaskModel tarea) {
        Bundle args = new Bundle();
        args.putString("taskTitle", tarea.getDescripcion());
        args.putInt("taskId", tarea.getId());
        NavHostFragment.findNavController(this).navigate(R.id.focusFragment, args);
    }
